...
#ifndef NUMBER_PARTS_SWIFT_H
#define NUMBER_PARTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="number_parts",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC12number_parts11AppDelegate")
...
SWIFT_CLASS("_TtC12number_parts17MainFlutterWindow")
